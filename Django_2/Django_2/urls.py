...
from Django2App import views

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', views.index, name='index'),
    path('Inscripcion/', views.Incripcion, name='Inscripcion'),
    path('ListaInscripciones/', views.ListaInscripciones, name='ListaInscripciones'),
